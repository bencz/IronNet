#ifndef _DNI_IRSTRUCTURES_H_
#define _DNI_IRSTRUCTURES_H_
...
IRType* IRAssembly_CreateGenericParameter(IRAssembly* pAssembly, bool pIsFromParentType, uint32_t pIndex);
...
bool IRType_IsSubclassOf(IRType* pType, IRType* pParentType);
bool IRType_ContainsReferenceType(IRType* pType);
