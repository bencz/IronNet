...
static const iron_opcode_info_t g_opcode_table[256] = {
    ...
    OP_UNUSED(0x82), OP_UNUSED(0x83), OP_UNUSED(0x84), OP_UNUSED(0x85),
    OP_UNUSED(0x86), OP_UNUSED(0x87), OP_UNUSED(0x88), OP_UNUSED(0x89),
    OP_UNUSED(0x8A), OP_UNUSED(0x8B),
    ...
    /* 0xB0-0xBF */
    OP_UNUSED(0xB0), OP_UNUSED(0xB1), OP_UNUSED(0xB2), OP_UNUSED(0xB3),
    OP_UNUSED(0xB4), OP_UNUSED(0xB5), OP_UNUSED(0xB6), OP_UNUSED(0xB7),
    OP_UNUSED(0xB8), OP_UNUSED(0xB9), OP_UNUSED(0xBA), OP_UNUSED(0xBB),
    OP_UNUSED(0xBC), OP_UNUSED(0xBD), OP_UNUSED(0xBE), OP_UNUSED(0xBF),
    /* 0xC0-0xCF */
    OP_UNUSED(0xC0), OP_UNUSED(0xC1), OP_UNUSED(0xC2), OP_UNUSED(0xC3),
    OP_UNUSED(0xC4), OP_UNUSED(0xC5), OP_UNUSED(0xC6), OP_UNUSED(0xC7),
    ...
    OP_UNUSED(0xD4), OP_UNUSED(0xD5), OP_UNUSED(0xD6), OP_UNUSED(0xD7),
    OP_UNUSED(0xD8), OP_UNUSED(0xD9), OP_UNUSED(0xDA), OP_UNUSED(0xDB),
